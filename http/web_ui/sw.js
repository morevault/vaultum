!function(){"use strict"
self.CACHE_BUSTER="1727895563923|0.9853881354669738",self.addEventListener("install",(function(e){return self.skipWaiting()})),self.addEventListener("message",(function(e){if("skipWaiting"===e.data)return self.skipWaiting()})),self.addEventListener("activate",(function(e){return self.clients.claim()}))
