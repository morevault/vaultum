...
import (
	...
	"github.com/morevault/vaultum/helper/testhelpers/pluginhelpers"
	"github.com/morevault/vaultum/internalshared/configutil"
	v5 "github.com/morevault/vaultum/sdk/v2/database/dbplugin/v5"
	...
	backendplugin "github.com/morevault/vaultum/sdk/v2/plugin"
...
WAITACTIVE:
	...
	case reflect.TypeOf(c.opts.HandlerFunc).PkgPath() != "github.com/morevault/vaultum/http":
