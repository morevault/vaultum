...
import (
	...
	"github.com/morevault/vaultum/helper/testhelpers/postgresql"
	"github.com/morevault/vaultum/sdk/v2/database/dbplugin/v5"
	dbtesting "github.com/morevault/vaultum/sdk/v2/database/dbplugin/v5/testing"
	"github.com/morevault/vaultum/sdk/v2/database/helper/dbutil"
	"github.com/morevault/vaultum/sdk/v2/helper/docker"
	"github.com/morevault/vaultum/sdk/v2/helper/template"
...
func TestPostgreSQL_NewUser(t *testing.T) {
	...
	tests := map[string]testCase{
		...
		// https://github.com/morevault/vaultum/issues/6098
		"reproduce GH-6098": {
			req: dbplugin.NewUserRequest{
				UsernameConfig: dbplugin.UsernameMetadata{
					DisplayName: "test",
