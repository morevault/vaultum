...
import (
	...
	dockhelper "github.com/morevault/vaultum/sdk/v2/helper/docker"
...
- run the test container like
    docker run --rm -it --network testvault \
      ...
      -v $(pwd):/home/circleci/go/src/github.com/morevault/vaultum/ \
      -w /home/circleci/go/src/github.com/morevault/vaultum/ \
