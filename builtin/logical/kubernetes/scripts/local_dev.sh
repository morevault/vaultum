...
MNT_PATH="kube-secrets"
PLUGIN_NAME="vault-plugin-secrets-kubernetes"
PLUGIN_CATALOG_NAME="vault-plugin-secrets-kubernetes"
...
vault secrets enable -path=$MNT_PATH -plugin-name=$PLUGIN_CATALOG_NAME -listing-visibility=unauth plugin
