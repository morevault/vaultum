	...
	return &framework.Path{
		...
		Fields: map[string]*framework.FieldSchema{
			...
			"generate": {
				...
				Default:     false,
				Description: "Determines if a key should be generated by OpenBao or if a key is being passed from another service.",
			},
...
func (b *backend) pathKeyList(ctx context.Context, req *logical.Request, data *framework.FieldData) (*logical.Response, error) {
	...
	entries, err := req.Storage.ListPage(ctx, "key/", after, limit)
	if err != nil {
		return nil, err
	}
