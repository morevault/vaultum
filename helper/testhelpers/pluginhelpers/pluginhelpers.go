...
func GetPlugin(t testing.T, typ consts.PluginType) (string, string, string, string) {
	...
	case consts.PluginTypeCredential:
		...
		pluginVersionLocation = fmt.Sprintf("github.com/morevault/vaultum/builtin/credential/%s.ReportedVersion", pluginType)
	case consts.PluginTypeSecrets:
		...
		pluginVersionLocation = fmt.Sprintf("github.com/morevault/vaultum/builtin/logical/%s.ReportedVersion", pluginType)
	case consts.PluginTypeDatabase:
		...
		pluginVersionLocation = fmt.Sprintf("github.com/morevault/vaultum/plugins/database/%s.ReportedVersion", pluginType)
	default:
		t.Fatal(typ.String())
	}
