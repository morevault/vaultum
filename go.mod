...
replace github.com/morevault/vaultum/api/auth/approle/v2 => ./api/auth/approle

replace github.com/morevault/vaultum/api/auth/kubernetes/v2 => ./api/auth/kubernetes

replace github.com/morevault/vaultum/api/auth/userpass/v2 => ./api/auth/userpass

replace github.com/morevault/vaultum/sdk/v2 => ./sdk
